  ...
  return (
    <CustomizerWrap>
      ...
      <CustomizerContent open={isOpen} hidden={!isOpen}>
        <CustomizerTitleWrap>
          <h5>Công cụ tùy chỉnh chủ đề</h5>
          <CustomizerCloseButton type="button" onClick={handleOpen}>
            <CloseIcon />
          </CustomizerCloseButton>
        </CustomizerTitleWrap>
        <CustomizerCaption>
          Tùy biến này cho phép bạn xem các biến thể khác nhau của nandhlogistics
          Tạo phong cách trực quan của riêng bạn cho mọi dự án bạn làm!
        </CustomizerCaption>
        <CustomizerToggle
          title="Thu gọn menu"
