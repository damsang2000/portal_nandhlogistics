...
export default () => (
  <Switch>
    ...
    />
    <Route
      path="/documentation/file_structure"
    ...
    />
    <Route
      path="/documentation/finance_dashboard"
      component={FinanceDashboardDoc}
    />
    <Route
    ...
    />
    <Route
      path="/documentation/color_themes"
      component={ColorThemes}
    />
    <Route
      path="/documentation/navigation_item"
