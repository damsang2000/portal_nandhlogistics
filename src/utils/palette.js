...
export const logoImg = theme('mode', {
  ...
  png: `url(${process.env.PUBLIC_URL}/img/logo/favicon.png)`,
});
...
export const colorRedHover5 = 'rgba(250, 177, 160,0.2)';
export const colorGrayHover = 'rgba(223, 230, 233,1.0)';
...
export const colorLightGray = '#f2f4f7';
