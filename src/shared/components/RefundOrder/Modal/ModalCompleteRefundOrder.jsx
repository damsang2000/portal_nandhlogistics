...
const ModalCompleteRefundOrder = (props) => {
  //? state extension
  ...
  //! handle render html while get api
  ...
  return (
    <>
      ...
      <ModalDetailASN
        ...
        dateto={props.dateto}
        title="Chi tiết đơn hàng hoàn đã xử lý"
        id={autoId}
        arrTrangThai={[1, 2, 3]}
        inputType={2}
...
export default ModalCompleteRefundOrder;
