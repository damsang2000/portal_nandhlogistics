...
const ReactTableCustomizer = ({
  ...
  const arrayTableCustomizerSingleToggle = [
    {
      id: 0, text: 'Chế độ lọc', func: handleClickWithSearchEngine, isChecked: withSearchEngine,
    },
    {
      id: 1, text: 'Chế độ có thể sắp xếp', func: handleClickIsSortable, isChecked: isSortable,
    },
    {
      id: 2, text: 'Chế độ phân trang', func: handleClickWithPagination, isChecked: withPagination,
    },
  ];
  const arrayTableCustomizerAddictionToggle = [
    {
      id: 0,
      text: 'Chế độ kéo và thả',
    ...
    {
      id: 2,
      text: 'Chế độ có thể thay đổi kích thước',
    ...
    <ReactTableCustomizerWrap>
      <div>
        ...
        <Collapse in={collapse}>
          <CollapseContent>
            <TitleWrap>
              <p>Tùy biến này cho phép bạn xem các biến thể khác nhau của bảng dữ liệu.</p>
            </TitleWrap>
            <CollapseItem>
